...
# Si la ejecutamos antes, no se van a mostrar los cambiops anteriores
ventana.mainloop() #Con este metodo mostramo la ventana, si o si tenes que usar este método para visualizar la ventana 
