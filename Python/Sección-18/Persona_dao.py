...
if __name__ == "__main__":
    ...
    # persona01 = Persona(nombre="Guido", apellido="Van Rossum", edad=68, email="ceocreadorpython@gmail.com")
    # personas_insertadas = PersonaDAO.insertar_bd(persona01)
    # log.debug(f"Personas insertadas: {personas_insertadas}")
    
    # Actualizar registro
    # persona01 = Persona(27, "Mark", "Zuckerberg", 40, "zuck@gmail.com")
    # personas_actualizadas = PersonaDAO.actualizar_bd(persona01)
    # log.debug(f"Personas actualizadas: {personas_actualizadas}")
    
    
    # Eliminar registro
    # persona01 = Persona(id_persona=27)
